...
# QDA (GRID SEARCH)
# =========================================================
print("\nTraining Optimized QDA (Quadratic Discriminant Analysis)...")

# Setup the QDA Pipeline
...
param_grid = {
    "model__reg_param": [0.0, 0.0001, 0.001, 0.01, 0.1, 0.5]
}

grid = GridSearchCV(
    estimator=qda_pipeline,
...
print("Best QDA Params:", grid.best_params_)
...
# SAVE PIPELINE
# =========================================================
save_path = os.path.join(SAVE_DIR, "best_qda_model.joblib")
joblib.dump(best_qda, save_path)

print("\n========================================")
print("Pipeline (Scaler + QDA) saved successfully.")
